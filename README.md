...
6. Smoke test: linked user posts a YouTube/Spotify/Apple Music URL in `#song-a-day` → ephemeral “Saved…”; entry appears on PondArbor Song-a-Day. Linked user posts “Does anyone have a table saw?” in `#closet` → thread I Do / I Don’t; matching friends’ items are DMed to the requester.
