...
SAY_MAX_LEN = 200
# Dark-area narrative (session play panel + look/search/read/inspect); keep in sync with frontend `QFF_NARRATIVE_TOO_DARK`.
NARRATIVE_TOO_DARK_MESSAGE = "It's too dark in here!"
