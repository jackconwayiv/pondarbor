...
const LABEL_TO_ID: Record<string, string> = {
  ...
  "Small Swimmers": "small_swimmers",
  "Small Swimmer": "small_swimmers",
...
const ROWS: ReadonlyArray<{ pair: string; name: string }> = [
  ...
  { pair: "Ripple & Small Swimmers", name: "Agile Stream" },
  ...
  { pair: "Sediment & Small Swimmers", name: "Bottom Scout" },
  ...
  { pair: "Fungus & Small Swimmers", name: "Nutrient Feeder" },
  ...
  { pair: "Microbe & Small Swimmers", name: "Inner Life" },
  { pair: "Zooplankton & Aquatic Plants", name: "Leafy Refuge" },
  { pair: "Zooplankton & Invertebrates", name: "Drifting Larvae" },
  { pair: "Zooplankton & Small Swimmers", name: "Open Water" },
  { pair: "Aquatic Plants & Invertebrates", name: "Garden Nursery" },
  { pair: "Aquatic Plants & Small Swimmers", name: "Hidden School" },
  { pair: "Invertebrates & Small Swimmers", name: "Predator Prey" },
  ...
  { pair: "Amphibians & Small Swimmers", name: "Dual Realm" },
  ...
  { pair: "Small Fish & Small Swimmers", name: "Schooling Life" },
  ...
  { pair: "Reptiles & Small Swimmers", name: "Patient Predator" },
  ...
  { pair: "Large Fish & Small Swimmers", name: "Open Hunter" },
  ...
  { pair: "Waterfowl & Small Swimmers", name: "Swift Predator" },
  ...
  { pair: "Shore Mammals & Small Swimmers", name: "Edge Hunter" },
  ...
  { pair: "Hunting Birds & Small Swimmers", name: "Raptor Dive" },
  ...
  { pair: "Great Mammals & Small Swimmers", name: "Wake Mover" },
  ...
  { pair: "Humans & Small Swimmers", name: "Casual Observer" },
  ...
  { pair: "Cryptids & Small Swimmers", name: "Furtive Lurker" },
  ...
  { pair: "Spirits & Small Swimmers", name: "Hidden Current" },
  ...
  { pair: "Leviathans & Small Swimmers", name: "Hidden Wake" },
  ...
  { pair: "Abyssals & Small Swimmers", name: "Faded Trace" },
  ...
  { pair: "Celestials & Small Swimmers", name: "Comet Trail" },
  ...
  { pair: "Transcendence & Small Swimmers", name: "Pure Motion" },
