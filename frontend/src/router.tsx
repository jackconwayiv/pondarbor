...
const BooksPage = lazy(() => import("./books/BooksPage"));
...
export const router = createAppRouter([
  {
    ...
    children: [
      ...
      {
        path: "books",
        element: authedRouteElement(lazyRouteElement(<BooksPage />)),
      },
      {
        path: "scorenado",
      ...
      {
        path: "people",
        element: authedRouteElement(lazyRouteElement(<PeoplePage />)),
      },
      {
        path: "calendar",
