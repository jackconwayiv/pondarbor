...
import { Navigate, Link as RouterLink, Outlet, useNavigate } from "react-router";
...
/** Gate for `/staff` and nested staff routes; renders matched child (`StaffPage`, `StaffZodiacPage`, …). */
export default function StaffShellRoute() {
  const {
    isAuthenticated,
    isLoading,
    sessionUser,
